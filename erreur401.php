...
<head>
    ...
    <META NAME="DESCRIPTION" CONTENT="Erreur 401 - Site du serveur GTA 5 LSRP [FR]">
    ...
    <title>Erreur 401 - Los Santos RolePlay</title>
...
<body>
    ...
    <section class="contact-area section-padding-100-0">
        ...
        <div class="row">
            ...
            <div class="col-sm-7">
                <div class="section-heading style-2">
                    <form method="POST" action="erreur401.php">
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
