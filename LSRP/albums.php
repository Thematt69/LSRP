...
<head>
    ...
    <title>Albums - Los Santos RolePlay</title>
...
<body>
    ...
    <section class="breadcumb-area bg-img bg-overlay" style="background-image: url(img/gta-v-4k-ti.jpg);">
        <div class="bradcumbContent">
            <p>Les meilleurs photos du serveur !</p>
            <h2>Albums</h2>
        </div>
    </section>
    <!-- ##### Breadcumb Area End ##### -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading style-2">
                        <h2>La page n'est pas disponible actuellement</h2>
