					...
					<div class="row">
						...
						<div class="col-md-4">
							...
							<div class="footer-widget about-widget">
								<div class="footer-logo">
									<a href="http://weazelnews.lsrpfr.com" class="logo"><img src="./img/logo-ctrl.png" alt=""></a>
									<p>Premier chaine d'information à Los Santos et ses environs.</p>
								</div>
							</div>
							<!-- /footer about -->
							...
							<div class="footer-widget social-widget">
								...
								<ul>
									<li><a href="https://www.facebook.com/Los-Santos-Roleplay-FR-274793476537865/" target="_blank" class="facebook"><i class="fa fa-facebook"></i></a></li>
						...
						<div class="col-md-4">
							...
							<div class="footer-widget galery-widget">
								<div class="widget-title">
									<h2 class="title">L'Insta-galerie</h2>
								</div>
								<ul>
							...
							<div class="footer-widget tweets-widget">
								<div class="widget-title">
									<h2 class="title">Tweets Récents</h2>
								</div>
								<ul>
									<li class="tweet">
					...
					<div class="row">
						...
						<div class="col-md-8">
							<div class="footer-copyright">
								...
								Copyright <a href="http://lsrpfr.com">Los Santos RP [FR]</a> &copy;2018 All rights reserved | This template is made with by <a href="https://colorlib.com" target="_blank">Colorlib</a></span>
							</div>
						</div>
						<!-- /footer copyright -->
