...
<head>
    ...
    <META NAME="DESCRIPTION" CONTENT="Erreur 403 - Site du serveur GTA 5 LSRP [FR]">
    ...
    <title>Erreur 403 - Los Santos RolePlay</title>
...
<body>
    ...
    <section class="contact-area section-padding-100-0">
        ...
        <div class="row">
            ...
            <div class="col-sm-7">
                <div class="section-heading style-2">
                    <form method="POST" action="erreur403.php">
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                ...
                                if ($_POST['message']!='')
                                {
                                    ...
                                    <html>
                                        <body>
                                            ...
                                            <p><strong>Object : </strong>Problème avec le site - Erreur 403</p>
