...
<head>
    ...
    <META NAME="DESCRIPTION" CONTENT="Erreur 404 - Site du serveur GTA 5 LSRP [FR]">
    ...
    <title>Erreur 404 - Los Santos RolePlay</title>
...
<body>
    ...
    <section class="contact-area section-padding-100-0">
        ...
        <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <h3>Un grand hacker a dù casser le site ou alors c'est toi qui la fais ?</h3>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-7">
                <div class="section-heading style-2">
                    <form method="POST" action="erreur404.php">
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                            ...
                            <?php
                                if ($_POST['message']!='')
                                {
                                    ...
                                    <html>
                                        <body>
                                            <h2>Voici les réponses au formulaire de recrutement</h2>
